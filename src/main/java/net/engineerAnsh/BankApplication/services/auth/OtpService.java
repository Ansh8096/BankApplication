...
import net.engineerAnsh.BankApplication.exception.AlreadyVerifiedException;
import net.engineerAnsh.BankApplication.exception.InvalidOtpException;
import net.engineerAnsh.BankApplication.exception.OtpBlockedException;
import net.engineerAnsh.BankApplication.exception.OtpExpiredException;
